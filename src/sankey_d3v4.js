d3.sankey = function() {
  ...
  function computeAbsolutePositions() {
    ...
    nodes.filter((item) => item.name === "nonUS_air")[0].x = x2;
    nodes.filter((item) => item.name === "nonUS_marine")[0].x = x2;
    nodes.filter((item) => item.name === "nonUS_land")[0].x = x2;
    ...
    nodes.filter((item) => item.name === "nonUS")[0].y = nodes.filter((item) => item.name === "nonUS")[0].y -
          y1Delta;
    nodes.filter((item) => item.name === "cdnFromOther")[0].y = nodes.filter((item) => item.name === "nonUS")[0].y
          + nodes.filter((item) => item.name === "nonUS")[0].dy + btwGroups1;
    ...
    const btwGroups2 = 80;
    // Group nonUS
    nodes.filter((item) => item.name === "nonUS_marine")[0].y = nodes.filter((item) => item.name === "nonUS_air")[0].y
          + nodes.filter((item) => item.name === "nonUS_air")[0].dy + withinGroups;
    nodes.filter((item) => item.name === "nonUS_land")[0].y = nodes.filter((item) => item.name === "nonUS_marine")[0].y
          + nodes.filter((item) => item.name === "nonUS_marine")[0].dy + withinGroups;

    // Group cdnFromOther
    nodes.filter((item) => item.name === "cdnFromOther_air")[0].y = nodes.filter((item) => item.name === "nonUS_land")[0].y
          + nodes.filter((item) => item.name === "nonUS_land")[0].dy + btwGroups2;
