export default class CopyButton {      
            ...
            //work around; Nodes for Copy button should be build when object is created.
            //but options are needed to set title, confirmation label and others texts
            //in order to send options here the dictionary must be loaded
            ...
            Build(options){
                ...
                this.nodes.btnCopy.addEventListener("click", this.onBtn_Click.bind(this));
            }			
            ...
            CopyData(lines){
              ...
              this.Clipboard(this.ToCSV("\t", lines), this.root);
            ...
            ToCSV(separator, lines) {											
              var csv = lines.map(line => line.join(separator));
