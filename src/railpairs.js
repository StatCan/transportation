(function () {
	...
	var chart = d3.select(".data").append("svg").attr("id", "demo");
	var id$1 = "year";
	var settings = {
	  alt: i18next.t("alt", {
	    ns: "area"
	  ...
	  z: {
	    ...
	    getKeys: function getKeys(object) {
	      ...
	      keys.splice(keys.indexOf(id$1), 1);
	...
	i18n.load(["src/i18n"], function () {
	  d3.queue().defer(d3.json, "data/rail/rail_meat_origATR_ON_BC_destQC.json").await(function (error, data) {
