...
this.areaChart = function(svg, settings, data) {
    ...
    const draw = function() {
      ...
      xAxisObj.call(
          d3.axisBottom(x)
              ...
              .tickSizeOuter(mergedSettings.x.tickSizeOuter)
      ...
      yAxisObj.call(
          d3.axisLeft(y)
              ...
              .tickSizeOuter(mergedSettings.y.tickSizeOuter)
    ...
    const drawTable = function() {
      ...
      const filteredData = (sett.z.origData && typeof sett.z.origData === "function") ?
      sett.z.origData.call(sett, data) : data;
        ...
        dataRow
          .append("td")
           .attr("headers", function(d, i) {
            ...
            .text(function(d) {
              if (sett.y.getText) {
                const thisValue = sett.y.getText.call(sett, d, keys[k]);
