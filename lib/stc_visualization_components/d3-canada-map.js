...
this.getCanadaMap = function(svg, settings) {
	...
	var canadaLayer = svg.append("g")
		...
		loadLayers = function() {
			...
			console.log("typeof settings: ", typeof settings.baseMap)
		...
		createBaseMap = function(canada, cb) {
			...
			try {
				var provincesKeys = Object.keys(provinces),
					p, provinceKey;
				console.log("provincesKeys: ", provincesKeys)
				...
				for(p = 0; p < provincesKeys.length; p += 1) {
					...
					console.log("settings.provinces: ", settings.provinces)
					//console.log("indexOf: ", settings.provinces.indexOf(provinceKey))
	...
	if (!settings.baseMap) {
		console.log("settings.baseMap: ", settings.baseMap)
