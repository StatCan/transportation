d3.sankey = function() {
  ...
  function checkLayout(parentObj, childrenObj) {
    console.log("checkLayout parentObj: ", parentObj)
    console.log("checkLayout childrenObj: ", childrenObj)

    var thisNode = nodes.filter(function (item) {
      return item.name === parentObj.name;
    })[0];
    console.log("checkLayout thisNode: ", thisNode)
    ...
    console.log("midNode, midNodeChildrenGroup: ", midNode, midNodeChildrenGroup)
