d3.sankey = function() {
  ...
  function computeAbsolutePositions() {
    ...
    var l2children = ["USres_land", "cdnFromUS_land"];
    if (l2children[0]) checkLayout(l2children[0], 7); // USres_land
    if (l2children[0]) checkLayout(l2children[1], 13); // cdnFromUS_land
  ...
  function checkLayout(nodeName, parentNodeNum) {
    ...
    if (nodes.filter(function (item) {return item.name === nodeName;}).length > 0) {
      ...
      if (children.length > 0) {
                ...
                if ([midNode, midNodeChildrenGroup].sort(function(a,b) { return a - b;})[0] /
                  ...
                  if (midNode > midNodeChildrenGroup) { // midNode should be moved up
                    ...
                    if (children[0].y - delta < 5) {
                      delta = children[0].y; // move first node to 0
                    }
